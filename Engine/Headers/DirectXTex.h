...
namespace DirectX
{
    ...
    EXPORT constexpr bool __cdecl IsValid(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT bool __cdecl IsCompressed(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT bool __cdecl IsPacked(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT bool __cdecl IsVideo(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT bool __cdecl IsPlanar(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT bool __cdecl IsPalettized(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT bool __cdecl IsDepthStencil(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT bool __cdecl IsSRGB(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT bool __cdecl IsTypeless(_In_ DXGI_FORMAT fmt, _In_ bool partialTypeless = true) noexcept;

    EXPORT bool __cdecl HasAlpha(_In_ DXGI_FORMAT fmt) noexcept;

    EXPORT size_t __cdecl BitsPerPixel(_In_ DXGI_FORMAT fmt) noexcept;

    EXPORT size_t __cdecl BitsPerColor(_In_ DXGI_FORMAT fmt) noexcept;
    ...
    EXPORT FORMAT_TYPE __cdecl FormatDataType(_In_ DXGI_FORMAT fmt) noexcept;
    ...
    EXPORT HRESULT __cdecl ComputePitch(
    ...
    EXPORT size_t __cdecl ComputeScanlines(_In_ DXGI_FORMAT fmt, _In_ size_t height) noexcept;

    EXPORT DXGI_FORMAT __cdecl MakeSRGB(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT DXGI_FORMAT __cdecl MakeTypeless(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT DXGI_FORMAT __cdecl MakeTypelessUNORM(_In_ DXGI_FORMAT fmt) noexcept;
    EXPORT DXGI_FORMAT __cdecl MakeTypelessFLOAT(_In_ DXGI_FORMAT fmt) noexcept;
    ...
    struct TexMetadata
    {
        ...
        EXPORT size_t __cdecl ComputeIndex(_In_ size_t mip, _In_ size_t item, _In_ size_t slice) const noexcept;
            // Returns size_t(-1) to indicate an out-of-range error

        EXPORT bool __cdecl IsCubemap() const noexcept { return (miscFlags & TEX_MISC_TEXTURECUBE) != 0; }
            // Helper for miscFlags

        EXPORT bool __cdecl IsPMAlpha() const noexcept { return ((miscFlags2 & TEX_MISC2_ALPHA_MODE_MASK) == TEX_ALPHA_MODE_PREMULTIPLIED) != 0; }
        EXPORT void __cdecl SetAlphaMode(TEX_ALPHA_MODE mode) noexcept { miscFlags2 = (miscFlags2 & ~static_cast<uint32_t>(TEX_MISC2_ALPHA_MODE_MASK)) | static_cast<uint32_t>(mode); }
        EXPORT TEX_ALPHA_MODE __cdecl GetAlphaMode() const noexcept { return static_cast<TEX_ALPHA_MODE>(miscFlags2 & TEX_MISC2_ALPHA_MODE_MASK); }
            // Helpers for miscFlags2

        EXPORT bool __cdecl IsVolumemap() const noexcept { return (dimension == TEX_DIMENSION_TEXTURE3D); }
    ...
    EXPORT HRESULT __cdecl GetMetadataFromDDSMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ DDS_FLAGS flags,
        _Out_ TexMetadata& metadata) noexcept;
    EXPORT HRESULT __cdecl GetMetadataFromDDSFile(
        _In_z_ const wchar_t* szFile,
        _In_ DDS_FLAGS flags,
        _Out_ TexMetadata& metadata) noexcept;

    EXPORT HRESULT __cdecl GetMetadataFromHDRMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _Out_ TexMetadata& metadata) noexcept;
    EXPORT HRESULT __cdecl GetMetadataFromHDRFile(
        _In_z_ const wchar_t* szFile,
        _Out_ TexMetadata& metadata) noexcept;

    EXPORT HRESULT __cdecl GetMetadataFromTGAMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ TGA_FLAGS flags,
        _Out_ TexMetadata& metadata) noexcept;
    EXPORT HRESULT __cdecl GetMetadataFromTGAFile(
        _In_z_ const wchar_t* szFile,
        _In_ TGA_FLAGS flags,
        _Out_ TexMetadata& metadata) noexcept;

    EXPORT HRESULT __cdecl GetMetadataFromWICMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ WIC_FLAGS flags,
        _Out_ TexMetadata& metadata,
        _In_opt_ std::function<void __cdecl(IWICMetadataQueryReader*)> getMQR = nullptr);

    EXPORT HRESULT __cdecl GetMetadataFromWICFile(
        _In_z_ const wchar_t* szFile,
        _In_ WIC_FLAGS flags,
        _Out_ TexMetadata& metadata,
        _In_opt_ std::function<void __cdecl(IWICMetadataQueryReader*)> getMQR = nullptr);
    ...
    {
    public:
        EXPORT ScratchImage() noexcept
            : m_nimages(0), m_size(0), m_metadata{}, m_image(nullptr), m_memory(nullptr) {}
        EXPORT ScratchImage(ScratchImage&& moveFrom) noexcept
            : m_nimages(0), m_size(0), m_metadata{}, m_image(nullptr), m_memory(nullptr) { *this = std::move(moveFrom); }
        EXPORT ~ScratchImage() { Release(); }

        EXPORT ScratchImage& __cdecl operator= (ScratchImage&& moveFrom) noexcept;

        EXPORT ScratchImage(const ScratchImage&) = delete;
        EXPORT ScratchImage& operator=(const ScratchImage&) = delete;

        EXPORT HRESULT __cdecl Initialize(_In_ const TexMetadata& mdata, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;

        EXPORT HRESULT __cdecl Initialize1D(_In_ DXGI_FORMAT fmt, _In_ size_t length, _In_ size_t arraySize, _In_ size_t mipLevels, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        EXPORT HRESULT __cdecl Initialize2D(_In_ DXGI_FORMAT fmt, _In_ size_t width, _In_ size_t height, _In_ size_t arraySize, _In_ size_t mipLevels, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        EXPORT HRESULT __cdecl Initialize3D(_In_ DXGI_FORMAT fmt, _In_ size_t width, _In_ size_t height, _In_ size_t depth, _In_ size_t mipLevels, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        EXPORT HRESULT __cdecl InitializeCube(_In_ DXGI_FORMAT fmt, _In_ size_t width, _In_ size_t height, _In_ size_t nCubes, _In_ size_t mipLevels, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;

        EXPORT HRESULT __cdecl InitializeFromImage(_In_ const Image& srcImage, _In_ bool allow1D = false, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        EXPORT HRESULT __cdecl InitializeArrayFromImages(_In_reads_(nImages) const Image* images, _In_ size_t nImages, _In_ bool allow1D = false, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        EXPORT HRESULT __cdecl InitializeCubeFromImages(_In_reads_(nImages) const Image* images, _In_ size_t nImages, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;
        EXPORT HRESULT __cdecl Initialize3DFromImages(_In_reads_(depth) const Image* images, _In_ size_t depth, _In_ CP_FLAGS flags = CP_FLAGS_NONE) noexcept;

        EXPORT void __cdecl Release() noexcept;

        EXPORT bool __cdecl OverrideFormat(_In_ DXGI_FORMAT f) noexcept;

        EXPORT const TexMetadata& __cdecl GetMetadata() const noexcept { return m_metadata; }
        EXPORT const Image* __cdecl GetImage(_In_ size_t mip, _In_ size_t item, _In_ size_t slice) const noexcept;

        EXPORT const Image* __cdecl GetImages() const noexcept { return m_image; }
        EXPORT size_t __cdecl GetImageCount() const noexcept { return m_nimages; }

        EXPORT uint8_t* __cdecl GetPixels() const noexcept { return m_memory; }
        EXPORT size_t __cdecl GetPixelsSize() const noexcept { return m_size; }

        EXPORT bool __cdecl IsAlphaAllOpaque() const noexcept;
    ...
    {
    public:
        EXPORT Blob() noexcept : m_buffer(nullptr), m_size(0) {}
        EXPORT Blob(Blob&& moveFrom) noexcept : m_buffer(nullptr), m_size(0) { *this = std::move(moveFrom); }
        EXPORT ~Blob() { Release(); }

        EXPORT Blob& __cdecl operator= (Blob&& moveFrom) noexcept;

        EXPORT Blob(const Blob&) = delete;
        EXPORT Blob& operator=(const Blob&) = delete;

        EXPORT HRESULT __cdecl Initialize(_In_ size_t size) noexcept;

        EXPORT void __cdecl Release() noexcept;

        EXPORT void *__cdecl GetBufferPointer() const noexcept { return m_buffer; }
        EXPORT size_t __cdecl GetBufferSize() const noexcept { return m_size; }

        EXPORT HRESULT __cdecl Trim(size_t size) noexcept;
    ...
    // DDS operations
    EXPORT HRESULT __cdecl LoadFromDDSMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ DDS_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;
    EXPORT HRESULT __cdecl LoadFromDDSFile(
        _In_z_ const wchar_t* szFile,
        _In_ DDS_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;

    EXPORT HRESULT __cdecl SaveToDDSMemory(
    ...
    EXPORT HRESULT __cdecl SaveToDDSFile(_In_ const Image& image, _In_ DDS_FLAGS flags, _In_z_ const wchar_t* szFile) noexcept;
    EXPORT HRESULT __cdecl SaveToDDSFile(
        _In_reads_(nimages) const Image* images, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        _In_ DDS_FLAGS flags, _In_z_ const wchar_t* szFile) noexcept;

    // HDR operations
    EXPORT HRESULT __cdecl LoadFromHDRMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;
    EXPORT HRESULT __cdecl LoadFromHDRFile(
        _In_z_ const wchar_t* szFile,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;

    EXPORT HRESULT __cdecl SaveToHDRMemory(_In_ const Image& image, _Out_ Blob& blob) noexcept;
    EXPORT HRESULT __cdecl SaveToHDRFile(_In_ const Image& image, _In_z_ const wchar_t* szFile) noexcept;

    // TGA operations
    EXPORT HRESULT __cdecl LoadFromTGAMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ TGA_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;
    EXPORT HRESULT __cdecl LoadFromTGAFile(
        _In_z_ const wchar_t* szFile,
        _In_ TGA_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image) noexcept;

    EXPORT HRESULT __cdecl SaveToTGAMemory(_In_ const Image& image,
        _In_ TGA_FLAGS flags,
        _Out_ Blob& blob, _In_opt_ const TexMetadata* metadata = nullptr) noexcept;
    EXPORT HRESULT __cdecl SaveToTGAFile(_In_ const Image& image,
        _In_ TGA_FLAGS flags,
        _In_z_ const wchar_t* szFile, _In_opt_ const TexMetadata* metadata = nullptr) noexcept;

    // WIC operations
    EXPORT HRESULT __cdecl LoadFromWICMemory(
        _In_reads_bytes_(size) const void* pSource, _In_ size_t size,
        _In_ WIC_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image,
        _In_opt_ std::function<void __cdecl(IWICMetadataQueryReader*)> getMQR = nullptr);
    EXPORT HRESULT __cdecl LoadFromWICFile(
        _In_z_ const wchar_t* szFile, _In_ WIC_FLAGS flags,
        _Out_opt_ TexMetadata* metadata, _Out_ ScratchImage& image,
        _In_opt_ std::function<void __cdecl(IWICMetadataQueryReader*)> getMQR = nullptr);

    EXPORT HRESULT __cdecl SaveToWICMemory(
    ...
    EXPORT HRESULT __cdecl SaveToWICFile(
        _In_ const Image& image, _In_ WIC_FLAGS flags, _In_ REFGUID guidContainerFormat,
    ...
    EXPORT HRESULT __cdecl SaveToTGAMemory(_In_ const Image& image, _Out_ Blob& blob, _In_opt_ const TexMetadata* metadata = nullptr) noexcept;
    EXPORT HRESULT __cdecl SaveToTGAFile(_In_ const Image& image, _In_z_ const wchar_t* szFile, _In_opt_ const TexMetadata* metadata = nullptr) noexcept;
    ...
    EXPORT HRESULT __cdecl FlipRotate(_In_ const Image& srcImage, _In_ TEX_FR_FLAGS flags, _Out_ ScratchImage& image) noexcept;
    EXPORT HRESULT __cdecl FlipRotate(
    ...
    EXPORT HRESULT __cdecl Convert(
    ...
    EXPORT HRESULT __cdecl ConvertToSinglePlane(_In_ const Image& srcImage, _Out_ ScratchImage& image) noexcept;
    EXPORT HRESULT __cdecl ConvertToSinglePlane(
        _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        _Out_ ScratchImage& image) noexcept;
        // Converts the image from a planar format to an equivalent non-planar format

    EXPORT HRESULT __cdecl GenerateMipMaps(
    ...
    EXPORT HRESULT __cdecl GenerateMipMaps3D(
    ...
    EXPORT HRESULT __cdecl ScaleMipMapsAlphaForCoverage(
    ...
    EXPORT HRESULT __cdecl PremultiplyAlpha(_In_ const Image& srcImage, _In_ TEX_PMALPHA_FLAGS flags, _Out_ ScratchImage& image) noexcept;
    EXPORT HRESULT __cdecl PremultiplyAlpha(
        _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
    ...
    EXPORT HRESULT __cdecl Compress(
    ...
    EXPORT HRESULT __cdecl Decompress(_In_ const Image& cImage, _In_ DXGI_FORMAT format, _Out_ ScratchImage& image) noexcept;
    EXPORT HRESULT __cdecl Decompress(
    ...
    EXPORT HRESULT __cdecl ComputeNormalMap(
    ...
    EXPORT HRESULT __cdecl CopyRectangle(
    ...
    EXPORT HRESULT __cdecl ComputeMSE(_In_ const Image& image1, _In_ const Image& image2, _Out_ float& mse, _Out_writes_opt_(4) float* mseV, _In_ CMSE_FLAGS flags = CMSE_DEFAULT) noexcept;

    EXPORT HRESULT __cdecl EvaluateImage(
        _In_ const Image& image,
    ...
    EXPORT HRESULT __cdecl TransformImage(
        _In_ const Image& image,
    ...
    EXPORT REFGUID __cdecl GetWICCodec(_In_ WICCodecs codec) noexcept;

    EXPORT IWICImagingFactory* __cdecl GetWICFactory(bool& iswic2) noexcept;
    EXPORT void __cdecl SetWICFactory(_In_opt_ IWICImagingFactory* pWIC) noexcept;

    //---------------------------------------------------------------------------------
    // Direct3D 11 functions
#if defined(__d3d11_h__) || defined(__d3d11_x_h__)
    EXPORT bool __cdecl IsSupportedTexture(_In_ ID3D11Device* pDevice, _In_ const TexMetadata& metadata) noexcept;

    EXPORT HRESULT __cdecl CreateTexture(
    ...
    EXPORT HRESULT __cdecl CreateShaderResourceView(
        _In_ ID3D11Device* pDevice, _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        _Outptr_ ID3D11ShaderResourceView** ppSRV) noexcept;

    EXPORT HRESULT __cdecl CreateTextureEx(
        _In_ ID3D11Device* pDevice, _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
    ...
    EXPORT HRESULT __cdecl CreateShaderResourceViewEx(
        _In_ ID3D11Device* pDevice, _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        _In_ D3D11_USAGE usage, _In_ unsigned int bindFlags, _In_ unsigned int cpuAccessFlags, _In_ unsigned int miscFlags, _In_ bool forceSRGB,
        _Outptr_ ID3D11ShaderResourceView** ppSRV) noexcept;

    EXPORT HRESULT __cdecl CaptureTexture(_In_ ID3D11Device* pDevice, _In_ ID3D11DeviceContext* pContext, _In_ ID3D11Resource* pSource, _Out_ ScratchImage& result) noexcept;
#endif

    //---------------------------------------------------------------------------------
    // Direct3D 12 functions
#if defined(__d3d12_h__) || defined(__d3d12_x_h__) || defined(__XBOX_D3D12_X__)
    EXPORT bool __cdecl IsSupportedTexture(_In_ ID3D12Device* pDevice, _In_ const TexMetadata& metadata) noexcept;
    ...
    EXPORT HRESULT __cdecl PrepareUpload(
        _In_ ID3D12Device* pDevice,
        _In_reads_(nimages) const Image* srcImages, _In_ size_t nimages, _In_ const TexMetadata& metadata,
        std::vector<D3D12_SUBRESOURCE_DATA>& subresources);

    EXPORT HRESULT __cdecl CaptureTexture(
